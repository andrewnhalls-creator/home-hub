...
export async function upsertMortgage(
  ...
  const parsed = mortgageSchema.safeParse({
    ...
    rateType: formData.get("rateType") || "fijo",
    euriborSpread: formData.get("euriborSpread") || undefined,
    fixedPeriodEndDate: formData.get("fixedPeriodEndDate") || undefined,
  ...
  const payload = {
    ...
    original_principal: parsed.data.originalPrincipal === "" || parsed.data.originalPrincipal === undefined ? null : parsed.data.originalPrincipal,
    current_balance: parsed.data.currentBalance === "" || parsed.data.currentBalance === undefined ? null : parsed.data.currentBalance,
    ...
    euribor_spread: parsed.data.euriborSpread || null,
    fixed_period_end_date: parsed.data.fixedPeriodEndDate || null,
